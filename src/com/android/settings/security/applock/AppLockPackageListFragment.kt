...
import com.android.settings.custom.fragments.AflDashboardFragment
...
class AppLockPackageListFragment : AflDashboardFragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        launchablePackages = AfterlifeUtils.launchablePackages(context)
